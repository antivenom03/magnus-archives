...
var gzip_hash = '243079231027958142449085785996983533254'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/magnus-archives'  // this value is replaced by the actual url prefix when compiled
}
